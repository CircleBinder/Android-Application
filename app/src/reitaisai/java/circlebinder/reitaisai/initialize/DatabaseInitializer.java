...
abstract class DatabaseInitializer implements Runnable, Legacy {
    ...
    private void initBlock() throws IOException {
        InputStream inputStream = resources.openRawResource(R.raw.reitaisai_blocks_ltsv);
    ...
    private void initCircle() throws IOException {
        InputStream inputStream = resources.openRawResource(R.raw.reitaisai_circles_ltsv);
        BufferedReader reader = null;
        try {
            reader = new BufferedReader(new InputStreamReader(inputStream));
            String line;
            ...
            while ((line = reader.readLine()) != null) {
                ...
                EventCircleTableForInsert insertCircle = new EventCircleTableForInsert.Builder()
                        ...
                        .setSpaceNoSub("b".equals(space.getNoSub()) ? 1 : 0)
                        .build();

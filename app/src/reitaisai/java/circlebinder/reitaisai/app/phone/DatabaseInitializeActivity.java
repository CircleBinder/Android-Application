...
import circlebinder.reitaisai.initialize.DatabaseInitializeService;
import circlebinder.reitaisai.initialize.IInitializeBindService;
...
public final class DatabaseInitializeActivity extends BaseActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reitaisai_activity_database_initialize);
        serviceBind = true;
        bindService(new Intent(this, DatabaseInitializeService.class), serviceConnection, 0);
        View finishedView = findViewById(R.id.reitaisai_activity_initialize_finished);
        ...
        handler = new InitializeHandler(
                findViewById(R.id.reitaisai_activity_initialize_progress),
                finishedView
        );

...
import circlebinder.common.flow.util.Utils;
import flow.Flow;
...
public class SimpleSwitcher extends ScreenSwitcher {
    ...
    @Override
    protected void transition(final ViewGroup container, Screen from, Screen to,
        ...
        if (fromView == null || direction == Flow.Direction.REPLACE) {

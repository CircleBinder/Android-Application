...
public class FrameScreenSwitcherView extends FrameLayout
    ...
    public FrameScreenSwitcherView(Context context) {
        super(context);
        container = new SimpleSwitcher.Factory(R.id.screen_switcher_tag, AppFlow.contextFactory()).createScreenSwitcher(this);
    ...
    public FrameScreenSwitcherView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public FrameScreenSwitcherView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {

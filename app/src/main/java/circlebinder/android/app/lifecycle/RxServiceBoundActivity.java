...
public abstract class RxServiceBoundActivity extends RxActivity {

    private final String TAG = RxServiceBoundActivity.class.getSimpleName();
    ...
    private void registerBServiceListener() {
        if (serviceIF == null) {
            ...
            bindService(RxBackgroundService.createIntent(this), serviceConnection, Context.BIND_AUTO_CREATE);
    ...
    private void sendCommand(BackgroundServiceCommand command) {
        ...
        try {
            ...
            serviceIF.sendCommand(new IObservableFactory(command));
